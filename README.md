...
5. 推理側は質問の代わりに「答えは『○○』ですか？」という質問をしてもよい。
6. 5. で質問された言葉と出題側が用意していた答えと一致した場合、出題側は"正解"と回答してゲームを終了する。
...
(参考: 文字数カウントが可能なサイトの例 [文字数・バイト数カウント(String Count)](https://tool-taro.com/string_count/))
