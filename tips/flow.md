...
- 成立年代:  
  そこそこ古い場合: 「**答えに関する歴史の中で重要な人物がいそうorイメージできる？**」
  - 言葉が表す何かの成立(通常)年代
  - 言葉自体が生み出されたor成立した年代
...
- 場所: 「**屋内にある？**」  
  ...
  - 屋内にも屋外にもある場合: 「**身につけるor持ち歩くor体内に存在することがある？**」
- 「**手で直接触れる？**」
...
- 「**材質はこれと言える？**」  
  Yesの場合: 木(植物)/金属/プラスチック/紙/石/布/ガラス/ゴム/... (※)
  妥当でない場合: 「**数種類以下の化学式で表される？**」
...
- 「**娯楽と関係ある？**」  
  ...
  - 場所
    -「その娯楽は**屋内？**」  
      Yesの場合: 音楽/映像(ドラマ/アニメ/映画/YouTube/...)/舞台/ゲーム/本(小説/漫画/絵本/...)/各種クリエイター/SNS/料理or食事/ギャンブル/パズルorゲーム(コンピューターゲーム/ボードゲームor駒を使うゲーム?/カードゲーム)/... (※)
    - 「その娯楽は**屋外？**」(≒アウトドアに近い?)  
