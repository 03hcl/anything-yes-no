...
- 「**固有名詞？**」
  - (固有名詞だが唯一といえるかわからない例: キットカット→味の種類がある?, サイゼリヤ→チェーン店?)
...
- 「**素材(材質)はこれと言える=素材を定義できる？**」  
  Yesの場合:
  - 性質的材料: 植物(木/紙/葉/茎/根/花/実/...)/金属/プラスチック(ビニール含む)/紙/石/布/ガラス/ゴム/樹脂/... (※)
  - 「**数種類以下の化学式で表される？**」
...
- 「**五感で感じることができる？**」  
  ...
  - Noの場合: (※)
    ...
    - 定期的なもの
      ...
      - 不定期
    - 時間性のないもの
      - (条件が変わらなければ) 定常的な何か: 状態/性質or特徴/地位,身分,立場or役割/権利/基準or規格/...  
        (例: 静止軌道)
      - 変化を含む何か: 現象/...  
        (例: 化学反応)
...
- 「**娯楽と関係ある？**」  
  ...
  - 場所
    -「その娯楽は**屋内？**」  
      Yesの場合: 音楽/映像(ドラマ/アニメ/映画/YouTube/...)/舞台/本(小説/漫画/絵本/...)/手芸or裁縫/料理or食事/パズルorゲーム(コンピューターゲーム/ボードゲームor駒を使うゲーム?/カードゲーム)/SNS/ギャンブル/生花/... (※)
