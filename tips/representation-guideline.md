...
| シャベル | ショベル | ※未定 |
| スーパー | スーパーマーケット | (\*0), (例: 「スーパーで買える？」) `スーパー(?!マーケット)` |
| 他人 | 他者 |
| ティッシュ | ティッシュペーパー | (\*0) |
| ドラッグストア | 薬局 | 本来の一般医薬品を販売する意味ではドラッグストアの方がよい? |
| 百均 | 百円均一, 百円ショップ | (\*0), 百均には税抜100円以外の商品もあることに注意? `100均\|(100\|百)円(均一\|ショップ)` |
| 連想(する,できる,可能) | イメージ(する,～) | ※未定,  `イメージ(?!では\|する\|[はをの]\|$)` |
| 問う | 尋ねる, 訊く |
...
- 出題側のイメージ・第一印象を問う場合: (例: 「○○しそう？」) といった表現を使う
